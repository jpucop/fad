...
window.groupData = {
  ...
  service_now: {
    ...
    assignment_groups: [
      { name: "AYSO", apps: ["ayso"] },
      { name: "CAF AWS Support", apps: [] },
      { name: "Corporate Systems Gateway (CSG)", apps: ["csg"] },
      { name: "FDW Tech Support", apps: ["fdw"] },
      { name: "ITF Retrofit Team", apps: ["itf"] },
      { name: "TM1 AWS Support", apps: ["mf"] },
      { name: "FIS AWS Tech Support", apps: ["ulo", "itf"] },
      { name: "FINAPPS AWS Tech Support", apps: ["ayso", "rems", "csg", "wage", "itf", "ise"] },
      { name: "FIS Concur Support", apps: ["itf", "ulo"] },
      { name: "Endowment & Investment Accounting Svcs", apps: ["eias"] },
      { name: "TCS Support", apps: ["tcs"] },
      { name: "Research Enterprise Management System (REMS)", apps: ["rems"] },
      { name: "BUD Retrofit Team", apps: ["csg"] },
      { name: "ACA Web Support", apps: ["aca"] }
    ]
  }
};
Alpine.data('app', () => ({
...
Alpine.start();
console.log('App initialized with mock groupData');